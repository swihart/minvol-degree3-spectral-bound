...
AI assistance was used extensively to explore proof strategies, carry out and
cross-check symbolic calculations, draft exposition, and prepare reproducibility
code. The named author is responsible for the decision to release this draft,
for accurately describing its provenance and verification status, and for
maintaining corrections. No AI system is listed as an author. Independent
expert verification of the complete proof has not yet occurred.
