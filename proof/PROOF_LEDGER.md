...
| T6 | Pairing counts for the six quartic moments | Hand count in `DEGREE3_TENSOR_IDENTITY.md`, Section 7; exhaustive exact pairing enumeration | Python exact-count check passed; matching R check included; needs local rerun/preserved output in current state |
